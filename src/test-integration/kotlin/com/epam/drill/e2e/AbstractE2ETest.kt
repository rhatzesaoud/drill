                ...
                runBlocking {
                    agents.map { (_, xx) ->
                        ...
                        launch(handler) {
                            ...
                            handleWebSocketConversation("/agent/attach", wsRequestRequiredParams(ag)) { inp, out ->
                            ...
                            thens.forEach { (ain, it) ->
                                ...
                                handleWebSocketConversation("/agent/attach", wsRequestRequiredParams(ain)) { inp, out ->
                                    ui.getAgent()
//                                    ui.getBuilds()
                                    val apply =
...
//        doHttpCall(agentId, token, HttpStatusCode.BadRequest)
//    }
//
//    fun TestApplicationEngine.
//        doHttpCall(agentId, token, HttpStatusCode.OK)
//    }
//
//    fun TestApplicationEngine.doHttpCall(agentId: String, token: String = globToken, exceptedStatus: HttpStatusCode) {
//        val status =
//            this.handleRequest(
//                HttpMethod.Post,
